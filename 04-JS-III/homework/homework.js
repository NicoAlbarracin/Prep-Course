...
function arrayContiene(array, elemento) {
  ...
  function agregarNumeros(numeros) {
    ...
    // Tu código:
    var sum = numeros.reduce((valorPrevio, valorActual) => {
...
function promedioResultadosTest(resultadosTest) {
  ...
  // Tu código:
  var sum = resultadosTest.reduce((valorPrevio, valorActual) => {
    return valorPrevio + valorActual;
  })
...
function numeroMasGrande(numeros) {
  ...
  // Tu código:
  var numeroGrande = Math.max(...numeros);
  return numeroGrande;
}
...
function multiplicarArgumentos() {
  ...
  multiplos = (arguments[i] * multiplos);
  }
return multiplos;
  }
}
